# Vitan Proof registers (Phase 0)

Internal-only. Two modes. Do not publish from this folder.

**Evidence Mode (Brand Storyteller)** holds locked facts. **Distribution Mode (Digital Presence Manager)** holds derived content. Nothing enters Distribution Mode without an approved Evidence Register entry (Vitan Growth Lead or Board).

Markdown in this folder is the human source of truth. Optional YAML, if present, must match markdown.

Report to **Vitan Growth Lead**, not Head / Current Clients.

## Public copy (when a claim is approved)
...
`Board-verified` | `PA-locked` | `yaml-unverified` | `PENDING`

Public copy may use only **Board-verified** or **PA-locked**.

Confidence: **high** only when Board-verified or PA-locked; **medium** yaml-unverified; **low** PENDING.

## Sources (in order)

1. Board / Chitrang / studio records
2. PA exact-wording lock
